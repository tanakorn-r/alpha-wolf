          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg bg-[#3ecf8e] px-3.5 py-2 text-xs font-bold text-[#06120c] disabled:cursor-not-allowed disabled:opacity-50"
              >
          ...
          <div className="flex flex-col gap-2">
            {hunt.top5.map(({ item, amount }, index) => (
              <div key={item.symbol} className="flex items-center gap-3 rounded-lg border border-[#2a2a31] bg-[#0e0e10] px-3.5 py-3">
                ...
                <span className="flex-none text-right font-mono text-sm text-[#3ecf8e]">
