...
const tabs: Array<{ key: HuntTab; label: string; premium?: boolean; tag?: string; tone?: "live" | "ultra" | "pro" }> = [
  ...
  { key: "history", label: "History", premium: true, tag: "PRO", tone: "pro" },
...
function TabGlyph({ tab }: { tab: HuntTab }) {
  ...
  if (tab === "history") return <svg width="13" height="13" viewBox="0 0 16 16" fill="none"><path d="M4 4h7a3 3 0 1 1 0 6H6" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" /><path d="m5 2.3-2 1.8 2 1.8M6 8h3M6 11h5M6 14h3" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" /></svg>;
