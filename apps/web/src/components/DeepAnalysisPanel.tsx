...
export function DeepAnalysisPanel() {
  ...
  return (
    <div className="fixed inset-0 z-[55] flex items-end justify-center overflow-hidden px-0 pb-[var(--aw-safe-bottom)] pt-[var(--aw-safe-top)] min-[720px]:items-start min-[720px]:overflow-y-auto min-[720px]:px-5 min-[720px]:py-6">
      ...
      <div ref={dialogRef as React.Ref<HTMLDivElement>} role="dialog" aria-modal="true" aria-labelledby={titleId} tabIndex={-1} className="aw-deep-panel deep-panel-in relative flex h-[calc(100dvh-var(--aw-safe-top)-var(--aw-safe-bottom))] w-[940px] max-w-full flex-col overflow-hidden rounded-t-2xl border border-[#2a2a31] bg-[#141417] shadow-[0_30px_90px_rgba(0,0,0,0.62)] outline-none min-[720px]:h-[calc(100vh-48px)] min-[720px]:rounded-2xl">
